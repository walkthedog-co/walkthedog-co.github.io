      ...
      (function () {
        ...
        da("Promise", function (a) {
          ...
          b.all = function (g) {
            ...
            return n.done ? d([]) : new b(function (p, v) {
              ...
              do {
                A.push(void 0), Q++, d(n.value).Qa(B(A.length - 1), v), n = h.next();
              } while (!n.done);
            });
          };
        ...
        */
        ...
        function xd(a, b, c, d, e) {
          if (Array.isArray(b)) for (var f = 0; f < b.length; f++) {
            xd(a, b[f], c, d, e);
          } else (d = m(d) ? !!d.capture : !!d, c = pd(c), a && a[dd]) ? (a = a.v, b = String(b).toString(), b in a.a && (f = a.a[b], c = id(f, c, d, e), -1 < c && (gd(f[c]), Array.prototype.splice.call(f, c, 1), 0 == f.length && (delete a.a[b], a.b--)))) : a && (a = sd(a)) && (b = a.a[b.toString()], a = -1, b && (a = id(b, c, d, e)), (c = -1 < a ? b[a] : null) && yd(c));
        }
        ...
        */
        ...
        function Yi(a, b, c, d, e, f, g) {
          ...
          return new D(function (v, B) {
            ...
            }, d, n ? void 0 : ke(Ve(e)), a.a, a.v.get());
          });
        }
          ...
          return cj(a).then(function (c) {
            a: {
              ...
              for (var f = 0; f < c.length; f++) {
                ...
                var h = d;
                var n = e;
                0 == g.indexOf("chrome-extension://") ? h = J(g).a == h && "chrome-extension" == n : "http" != n && "https" != n ? h = !1 : Ce.test(g) ? h = h == g : (g = g.split(".").join("\\."), h = new RegExp("^(.+\\." + g + "|" + g + ")$", "i").test(h));
        ...
        function mk(a, b, c, d) {
          ...
          return new D(function (A, Q) {
            B ? (e = Math.floor(Math.random() * Math.pow(10, 20)).toString(), B.port1.start(), h = setTimeout(function () {
              ...
              ya.data.eventId === e && ("ack" === ya.data.status ? (clearTimeout(h), n = setTimeout(function () {
                Q(Error("timeout"));
              }, 3E3)) : "done" === ya.data.status ? (clearTimeout(n), "undefined" !== typeof ya.data.response ? A(ya.data.response) : Q(Error("unknown_error"))) : (clearTimeout(h), clearTimeout(n), Q(Error("invalid_response"))));
            }, p = {
              messageChannel: B,
              onMessage: g
          ...
          function b(g) {
            ...
            yl(a).then(function (h) {
              ...
              if (h && g && g.url) {
                var p = null;
                n = xg(g.url);
                -1 != n.indexOf("/__/auth/callback") && (p = J(n), p = We(be(p, "firebaseError") || null), p = (p = "object" === typeof p ? Aa(p) : null) ? new sh(h.c, h.b, null, null, p, null, h.T()) : new sh(h.c, h.b, n, h.f, null, null, h.T()));
                n = p || c;
              }
        ...
        (function () {
          if ("undefined" !== typeof _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"] && _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].INTERNAL && _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].INTERNAL.registerComponent) {
            ...
            _firebase_app__WEBPACK_IMPORTED_MODULE_0__["default"].registerVersion("@firebase/auth", "0.16.2");
